...
public class RoutingConfig {
        ...
        public RouteLocator customRouteLocator(RouteLocatorBuilder builder) {
                return builder.routes()
                                ...
                                .route("account-auth-direct-route", r -> r
                                                .path("/auth/**")
                                                .uri(accountUri))
                                ...
                                .route("account-api-docs", r -> r
                                                ...
                                                .filters(f -> f.rewritePath("/v3/api-docs/account(?<path>.*)",
                                                                "/v3/api-docs${path}"))
                                                .uri(accountUri))
                                .route("payment-api-docs", r -> r
                                                .path("/v3/api-docs/payment/**")
                                                .filters(f -> f.rewritePath("/v3/api-docs/payment(?<path>.*)",
                                                                "/v3/api-docs${path}"))
                                                .uri(paymentUri))
                                .route("notification-api-docs", r -> r
                                                .path("/v3/api-docs/notification/**")
                                                .filters(f -> f.rewritePath("/v3/api-docs/notification(?<path>.*)",
                                                                "/v3/api-docs${path}"))
                                                .uri(notificationUri))
                                .build();
        }
